...
public class PanelDetallesRestaurante extends JPanel
{
    ...
    public PanelDetallesRestaurante( )
    {
        ...
        panelCal.add(new JLabel("Calificación: "));
        labCalificacion = new JLabel();
        panelCal.add(labCalificacion);
        add(panelCal);
        ...
        panelVis.add(new JLabel("Visitado: "));
        chkVisitado = new JCheckBox();
        chkVisitado.setEnabled(false); // solo lectura
    ...
    private void actualizarRestaurante( String nombre, int calificacion, boolean visitado )
    {
     // TODO completar actualizarRestaurante
    	...
    	//Lo que acabo de crear en el constructor
