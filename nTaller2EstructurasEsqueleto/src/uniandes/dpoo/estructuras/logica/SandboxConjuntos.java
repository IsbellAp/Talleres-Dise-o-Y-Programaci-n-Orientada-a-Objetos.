...
/** CONTRATOS: los emtodos publicos hacen parte de los contratos. 
 * 
 * 
 * @author isaca
 *
...
public class SandboxConjuntos
{
    ...
    //LA IDEA ES PODER SABER TODOS LOS METODOS DEL NAVIGABLESET QUE SON MUY PARECIDOS A LOS DE PYTHON-
    ...
    public List<String> getCadenasComoListaInvertida( )
    {
        ...
        //descendingSet devuelve el set ordenado pero al revés, dado que arboles cadena wviene lexicograficamente
        for (String a : arbolCadenas.descendingSet())
        {
        	lista.add(a);
        }
    ...
    {
    	//IMPORTANTE: Al ser un tree set, este ya de por sí no permite elementos repetidos, por lo que no tengo que controlarlo yo manualmente, solo agregarlo. 
    ...
    {
    	Iterator<String> a = arbolCadenas.iterator();

        while (a.hasNext())
        {
            if (a.next().equalsIgnoreCase(cadena))
            {
                a.remove();
            }
        }
    ...
    public void eliminarPrimera( )
    {
    	if (!arbolCadenas.isEmpty())
    	{
    		arbolCadenas.pollFirst();//remueve el primer elemento
    	}
    }
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
    	...
    	for (Object o: objetos) // objetos type Object
    	{
    ...
    {
    	//para evitar modificar el orden, voy a crear un nuevo set. 
    	
    	NavigableSet<String> nuevoaux = new TreeSet<String>();
    	
    	for (String a : arbolCadenas)
    	{
    		nuevoaux.add(a.toUpperCase());
    	}
    	
    	arbolCadenas = nuevoaux;
    }
    ...
    public TreeSet<String> invertirCadenas( )
    {
    	...
    	//recuerda que lexicograficamente puede significar de menor a mayor. 
        TreeSet<String> nuevoaux = new TreeSet<String>(Collections.reverseOrder());
